...
const line_annotations = [
{
    type: d3.annotationLabel,
    note: {
    title: "Weekday Checkins",
    label: "There are more checkins at night-time than day-time and note that the peak hour differs from state to state.",
    wrap: 190
    },
    x: 250,
    y: 125,
...
},          
{
    type: d3.annotationLabel,
    note: {
    title: "Weekend Checkins",
    label: "We have more customer checkins over the weekend",
    wrap: 190
    },
    x: 650,
    y: 200,
